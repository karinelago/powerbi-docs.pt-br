...
> 
> [!IMPORTANT]
> Administradores do Power BI podem desabilitar a capacidade dos usuários de usar Publicar na Web no portal de administração. Em **Configurações de Locatário**, defina **Publicar na Web** como **Desativado**. Essa á uma configuração completa de locatário. Para obter mais informações, consulte [Portal de administração do Power BI](service-admin-portal.md).
> 
> 
