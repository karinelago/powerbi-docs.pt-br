...
> [!NOTE]
> Caso encontre um problema que não esteja listado abaixo, é possível obter assistência no [site da comunidade](http://community.powerbi.com/) ou criar um [tíquete de suporte](https://powerbi.microsoft.com/support/).
> 
> 
