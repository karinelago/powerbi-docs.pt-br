...
* Se você for o proprietário do painel, poderá removê-lo. Se você compartilhou o dashboard com colegas, remover o dashboard de seu espaço de trabalho do Power BI removerá o dashboard do espaço de trabalho do Power BI de seus colegas.
...
Os conjuntos de dados podem ser excluídos. No entanto, excluir um conjunto de dados também exclui todos os relatórios e blocos de dashboard que contêm dados desse conjunto de dados.
