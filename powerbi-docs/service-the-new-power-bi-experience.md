...
Se você já usa o serviço do Power BI há algum tempo, sem dúvida percebeu que fizemos algumas alterações significativas na interface do usuário.  A maioria dessas mudanças afetam a maneira como seu conteúdo (dashboards, relatórios, conjuntos de dados) é organizado e os caminhos (cliques) que você segue para executar tarefas com esse conteúdo. 
...
## <a name="why-did-we-change-the-navigation-experience-for-power-bi-service"></a>Por que mudamos a experiência de navegação do serviço do Power BI?
...
## <a name="weve-added-some-brand-new-features"></a>Adicionamos alguns novos recursos
...
## <a name="favorite-dashboards"></a>Dashboards favoritos
...
3. Para abrir o painel de **Favoritos**, no menu de navegação à esquerda selecione **Favoritos** ou selecione o ícone de Favoritos ![](media/service-the-new-power-bi-experience/powerbi-star-icon.png).
