...
### <a name="direct-power-bi-trial-to-pro-customer-onboarding"></a>Integração de cliente direto da versão de avaliação do Power BI para a versão Pro
