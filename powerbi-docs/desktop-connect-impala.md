...
Quando solicitado, insira suas credenciais ou conecte-se anonimamente. O conector Impala suporta login Anonymouse, Básico (nome de usuário + senha) e autenticação do Windows.
