...
Para obter mais informações sobre como adquirir e atribuir licenças do Power BI Pro a usuários em sua organização, consulte [Comprar o Power BI Pro](service-admin-purchasing-power-bi-pro.md).
...
A tabela a seguir fornece detalhes sobre os eventos que você pode ver.

| **Evento** | **Descrição** | **Detalhes adicionais** |
| --- | --- | --- |
...
| Criar conjunto de dados |Essa atividade é registrada sempre que um conjunto de dado é criado. |Nome do conjunto de dados, DataConnectivityMode |
| Excluir conjunto de dados |Essa atividade é registrada sempre que um conjunto de dado é excluído. |Nome do conjunto de dados, DataConnectivityMode |
