...
| [Usar o painel Filtros do relatório](power-bi-how-to-report-filter.md) | Sim, é possível usar os filtros existentes e as alterações podem ser salvas com o relatório, mas não é possível adicionar novos filtros. | Sim |
