...
## <a name="help-with-other-issues-when-launching-power-bi-desktop"></a>Ajuda com outros problemas ao iniciar **Power BI Desktop**
...
Se o problema ao iniciar o **Power BI Desktop** não é associado com o gateway de dados local ou então quando as resoluções anteriores não funcionam, você pode enviar um incidente de suporte para o [suporte do Power BI](https://support.powerbi.com) ( https://support.powerbi.com) para ajudar a identificar e resolver o problema.
